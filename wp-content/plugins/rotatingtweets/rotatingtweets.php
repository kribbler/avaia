...
function rotating_tweets_display($json,$args,$print=FALSE) {
	...
	if(isset($args['show_meta_prev_next']) && $args['show_meta_prev_next']):
		$nextprev_prev = '<a href="javascript:void(0);" class="'.$id.'_rtw_prev rtw_prev">'.wp_kses_post($args['prev']).'</a>';
		$nextprev_next = '<a href="javascript:void(0);" class="'.$id.'_rtw_next rtw_next">'.wp_kses_post($args['next']).'</a>';
		//$nextprev = $nextprev_prev.wp_kses_post($args['middot']).$nextprev_next;
		$nextprev = $nextprev_prev.$nextprev_next;
		/*
		...
		*/
		$result .= '<div class="tweets_prev">' . $nextprev_prev . '</div>';
	endif;
...
*/
	...
	$result .= '<div class="tweets_next">' . $nextprev_next . '</div>';
