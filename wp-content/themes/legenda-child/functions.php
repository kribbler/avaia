...
add_image_size( 'homepage-small-thumb', 100, 100, true);

function child_ts_theme_widgets_init(){
    register_sidebar( array(
        'name' => __( 'Header Text', 'legenda' ),
        'id' => 'header-text',
    ...
    register_sidebar( array(
        'name' => __( 'Homepage Twitter', 'legenda' ),
        'id' => 'homepage-twitter',
...
add_shortcode( 'show_twitter_widget', 'show_twitter_widget' );
function show_twitter_widget() {
...
function etheme_inner_logo(){
    echo '<a href="'.site_url().'"><img src="'.get_stylesheet_directory_uri().'/images/logo_avaia.png" /></a>';
}
function pr($str){
