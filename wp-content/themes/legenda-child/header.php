...
<body <?php body_class(); ?>>
	...
	<div class="header-wrapper<?php if(etheme_get_option('fade_animation')): ?> fade-in delay1<?php endif; ?> header-type-<?php echo $ht; ?>">
		...
		<header class="header header<?php echo $ht; ?> header_inside">
			<div class="container">
				<div id="header_phone_inside"><a href="<?php echo site_url();?>/contact/"><?php dynamic_sidebar('header-phone'); ?></a></div>
				<div id="header_phone_inside_call"><a href="tel:705.325.0511"><?php dynamic_sidebar('header-phone'); ?></a></div>
				<div class="table-row">
