...
<body <?php body_class(); ?>>
	...
	<?php $ht = ''; $ht = apply_filters('custom_header_filter',$ht); $ht = 2;?>
	...
	<div class="page-wrapper page_services container">
	...
	<div class="header-wrapper<?php if(etheme_get_option('fade_animation')): ?> fade-in delay1<?php endif; ?> header-type-<?php echo $ht; ?>">
		...
		<header class="header header<?php echo $ht; ?> header_inside">
			<div class="container">
				<div id="header_phone_inside"><?php dynamic_sidebar('header-phone'); ?></div>
				<div class="table-row">
					...
					<div class="logo"><?php etheme_inner_logo(); ?></div>
		...
		<div class="main-nav visible-desktop page_inside">
	...
	<?php 
		...
		if ($image[0]) {?>
			<div class="featured-image-header" style="background-image: url(<?php echo $image[0];?>);">
				<h1>SERVICES</h1>
				<?php echo get_post_meta($post->ID, 'header_text', true); ?>
				<?php $page_title = get_the_title($post->ID); 
				//var_dump($page_title);
				
				?>
				<ul id="services_links">
					<li><a class="<?php echo (stripos($page_title, "manicures")) ? 'active' : ''; ?>" href="<?php echo site_url();?>/services-manicures/">Manicures</a></li>
					<li><a class="<?php echo (stripos($page_title, "hair")) ? 'active' : ''; ?>" href="<?php echo site_url();?>/services-hair/">Hair</a></li>
					<li><a class="<?php echo (stripos($page_title, "body")) ? 'active' : ''; ?>" href="<?php echo site_url();?>/services-body-wraps/">Body Wraps</a></li>
					<li><a class="<?php echo (stripos($page_title, "Tanning")) ? 'active' : ''; ?>" href="<?php echo site_url();?>/services-tanning/">Tanning</a></li>
					<li><a class="<?php echo (stripos($page_title, "Aromatherapy")) ? 'active' : ''; ?>" href="<?php echo site_url();?>/services-aromatherapy/">Aromatherapy</a></li>
					<li><a class="<?php echo (stripos($page_title, "Pedicures")) ? 'active' : ''; ?>" href="<?php echo site_url();?>/services-pedicures/">Pedicures</a></li>
					<li><a class="<?php echo (stripos($page_title, "Facials")) ? 'active' : ''; ?>" href="<?php echo site_url();?>/services-facials/">Facials</a></li>
					<li><a class="<?php echo (stripos($page_title, "Massage")) ? 'active' : ''; ?>" href="<?php echo site_url();?>/services-massage/">Massage</a></li>
					<li><a class="<?php echo (stripos($page_title, "Makeup")) ? 'active' : ''; ?>" href="<?php echo site_url();?>/services-makeup/">Makeup</a></li>
					<li><a class="<?php echo (stripos($page_title, "Waxing")) ? 'active' : ''; ?>" href="<?php echo site_url();?>/services-waxing/">Waxing</a></li>
				</ul>

				<a id="page_scroll_down" href="#main_page_scroll"><img id="scroll_down" src="<?php echo get_stylesheet_directory_uri(); ?>/images/arrow_down.png" /></a>
			</div>
		<?php }
